...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '71', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '72', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '73', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '74', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '75', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
SELECT p.player_id, c.card_id FROM player p, c WHERE p.player_name = 'Kris Middleton';

WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '76', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '77', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '78', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '79', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '80', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '81', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '82', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '83', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '84', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '85', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '86', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '87', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '88', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '89', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '90', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '91', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '92', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '93', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '94', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '95', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '96', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '97', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '98', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '99', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
SELECT p.player_id, c.card_id FROM player p, c WHERE p.player_name = 'Joel Embiid';
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '100', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '101', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '102', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '103', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '104', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '105', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '106', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '107', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '108', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '109', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '110', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '111', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '112', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
SELECT p.player_id, c.card_id FROM player p, c WHERE p.player_name = 'Vicotr Oladipo';

WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '113', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '114', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '115', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '116', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '117', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '118', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '119', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '120', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '121', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '122', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '123', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '124', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '125', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '126', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '127', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '128', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '129', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '130', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '131', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '132', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '133', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '134', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '135', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '136', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '137', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '138', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '139', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '140', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '141', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '142', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '143', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '144', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '145', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '146', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '147', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '148', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '149', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '150', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '151', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '152', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '153', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '154', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '155', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '156', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '157', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '158', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '159', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '160', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '161', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '162', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '163', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '164', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '165', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '166', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '167', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '168', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '169', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '170', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '171', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '172', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '173', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '174', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '175', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '176', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '177', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
SELECT p.player_id, c.card_id FROM player p, c WHERE p.player_name = 'Luka Doncic';
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '178', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '179', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '180', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '181', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '182', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '183', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '184', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '185', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '186', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '187', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '188', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '189', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '190', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '191', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '192', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '193', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '194', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '195', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '196', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '197', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '198', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '199', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
...
WITH c AS (
	INSERT INTO card (card_name, card_number, image, set_id)
	SELECT 'Base', '200', '.jpg', set_id FROM set WHERE set_name = 'Optic' AND year = 2018
	RETURNING card_id
)
INSERT INTO player_card (player_id, card_id)
